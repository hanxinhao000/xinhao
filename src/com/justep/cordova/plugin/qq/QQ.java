package com.justep.cordova.plugin.qq;
    ...
    private boolean ssoLogin(CallbackContext callbackContext) {
        ...
        if (mTencent.isSessionValid()) {
            ...
            Runnable runnable = new Runnable() {
                ...
                @Override
                public void run() {
                    mTencent.login(QQ.this.cordova.getActivity(), "all",
                            loginListener);
//					mTencent.loginServerSide(QQ.this.cordova.getActivity(), "all",
//							loginListener);
                }
            };
    ...
    private boolean qqshare(JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        this.cordova.getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mTencent.shareToQQ(QQ.this.cordova.getActivity(), params,
                        qqShareListener);
            }
        });
    ...
    private boolean checkClientInstalled(CallbackContext callbackContext) {
        Boolean installed = mTencent.isSupportSSOLogin(QQ.this.cordova.getActivity());
        if (installed) {
            callbackContext.success();
        } else {
    ...
    private boolean shareToQzone(JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        this.cordova.getActivity().runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                mTencent.shareToQzone(QQ.this.cordova.getActivity(), params,
                        qZoneShareListener);
            }
        });
        return true;
    ...
    private boolean addToQQFavorites(JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        this.cordova.getActivity().runOnUiThread(new Runnable() {
            ...
            @Override
            public void run() {
                mTencent.addToQQFavorites(QQ.this.cordova.getActivity(), params,
